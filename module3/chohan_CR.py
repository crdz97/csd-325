...
"""Cho-Han, modified by Carolina Rodriguez. Assignment 3.2 
...
IMPORTANT: If the dice total equals 2 or 7, you earn a 10 mon bonus!
''')
...
while True:  # Main game loop.
    ...
    if total in (2, 7):
        print('You rolled a', dice1 + dice2, 'You get a 10 mon bonus!')
        purse += 10
